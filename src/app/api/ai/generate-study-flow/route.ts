...
const SYSTEM_PROMPT = `You are an expert qualitative research designer. Create a complete interview flow structure for an AI-led interview study.
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { projectBasics, additionalDetails } = validated;
